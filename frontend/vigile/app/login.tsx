    ...
    const onSubmit = async (data: LoginForm) => {
        ...
        try {
            ...
            if (response.user.role !== 'vigile') {
                Alert.alert(
                    'Accès refusé',
                    'Seuls les vigiles peuvent accéder à cette application.'
                );
                return;
            }
    ...
    return (
        ...
        >
            <View style={styles.formContainer}>
                <Text style={styles.title}>Connexion Vigile</Text>
                <Text style={styles.subtitle}>Connectez-vous pour scanner les invitations</Text>
